...
const UpdateProfile = () => {
  ...
  useEffect(() => {
    if (artist.data) {
      setValue("name", artist.data.name || "");
      setValue("email", artist.data.email || "");
      setValue("phoneNumber", artist.data.phoneNumber || "");
      setValue("dob", artist.data.dob || null);
      setValue("gender", artist.data.gender || "");
    }
